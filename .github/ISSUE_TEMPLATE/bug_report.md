...
NOTE: If this is a battle bug, please copy-paste the battle log from the battle in question. Do not simply give a link to the battle log, since battle logs expire (72h for PVP, 12h for PVE), but instead copy-paste the battle log directly into the issue.
