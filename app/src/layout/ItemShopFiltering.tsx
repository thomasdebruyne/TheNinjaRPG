...
const ItemShopFiltering: React.FC<ItemShopFilteringProps> = (props) => {
  ...
  if (props.restrictTypes)
    categories = categories.filter((t) => props.restrictTypes?.includes(t));
    ...
    <Popover>
      ...
      <PopoverContent className="min-w-96">
        <div className="grid grid-cols-2 gap-1 gap-x-3">
          ...
          <div>
            <Select
              onValueChange={(e) => setRarity(e as ItemRarity)}
              value={itemRarity}
            >
          ...
          {/* Slot */}
          <div>
            <Select onValueChange={(e) => setSlot(e as ItemSlotType)} value={slot}>
